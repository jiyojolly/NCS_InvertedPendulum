...
## Generated on : Thu Nov 08 21:50:15 2018
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/krish/Desktop/Aalto/studies/SEMEST~1/SEMEST~1/DIGITA~1/Lab/LAB_B
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = LabB_CheckCommunications_ref.rsp
...
%.o : $(START_DIR)/RASPlib/src/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/RASPlib/src/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
encoder_arduino.o : $(START_DIR)/RASPlib/blocks/../src/encoder_arduino.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
