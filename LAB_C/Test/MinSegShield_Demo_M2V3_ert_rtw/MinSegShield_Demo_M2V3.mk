###########################################################################
## Makefile generated for Simulink model 'MinSegShield_Demo_M2V3'. 
## 
## Makefile     : MinSegShield_Demo_M2V3.mk
## Generated on : Tue Nov 06 23:20:13 2018
##  version:  
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/MinSegShield_Demo_M2V3.elf
...
PRODUCT_NAME              = MinSegShield_Demo_M2V3
MAKEFILE                  = MinSegShield_Demo_M2V3.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/krish/Desktop/Aalto/studies/SEMEST~1/SEMEST~1/DIGITA~1/Lab/LAB_B/Test
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = MinSegShield_Demo_M2V3_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/MinSegShield_Demo_M2V3.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/Users/krish/Documents/MATLAB/RASPlib/src -IC:/Users/krish/Documents/MATLAB/RASPlib/include -IC:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/shared/svd/include -IC:/ProgramData/MATLAB/SupportPackages/R2018a/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire -IC:/ProgramData/MATLAB/SupportPackages/R2018a/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/utility -IC:/ProgramData/MATLAB/SupportPackages/R2018a/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/src -IC:/ProgramData/MATLAB/SupportPackages/R2018a/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/src/utility -IC:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/arduinobase/include -I$(START_DIR)/MinSegShield_Demo_M2V3_ert_rtw -IC:/Users/krish/Documents/MATLAB/RASPlib/examples -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/mega -IC:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/arduinotarget/include -IC:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/arduinotarget/scheduler/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr -IC:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/shared/externalmode_daemon/include
...
DEFINES_STANDARD = -DMODEL=MinSegShield_Demo_M2V3 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : C:/ProgramData/MATLAB/SupportPackages/R2018a/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : C:/ProgramData/MATLAB/SupportPackages/R2018a/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : C:/ProgramData/MATLAB/SupportPackages/R2018a/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : C:/ProgramData/MATLAB/SupportPackages/R2018a/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/utility/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : C:/ProgramData/MATLAB/SupportPackages/R2018a/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/utility/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : C:/ProgramData/MATLAB/SupportPackages/R2018a/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/utility/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : C:/ProgramData/MATLAB/SupportPackages/R2018a/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/src/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : C:/ProgramData/MATLAB/SupportPackages/R2018a/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/src/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : C:/ProgramData/MATLAB/SupportPackages/R2018a/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/src/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : C:/ProgramData/MATLAB/SupportPackages/R2018a/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/src/utility/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : C:/ProgramData/MATLAB/SupportPackages/R2018a/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/src/utility/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : C:/ProgramData/MATLAB/SupportPackages/R2018a/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/src/utility/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : C:/Users/krish/Documents/MATLAB/RASPlib/src/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : C:/Users/krish/Documents/MATLAB/RASPlib/src/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : C:/Users/krish/Documents/MATLAB/RASPlib/src/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/MinSegShield_Demo_M2V3_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/MinSegShield_Demo_M2V3_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/MinSegShield_Demo_M2V3_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
encoder_arduino.o : C:/Users/krish/Documents/MATLAB/RASPlib/blocks/../src/encoder_arduino.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
