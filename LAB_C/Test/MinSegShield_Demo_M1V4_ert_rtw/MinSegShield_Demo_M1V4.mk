###########################################################################
## Makefile generated for Simulink model 'MinSegShield_Demo_M1V4'. 
## 
## Makefile     : MinSegShield_Demo_M1V4.mk
## Generated on : Tue Nov 06 20:26:27 2018
##  version:  
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/MinSegShield_Demo_M1V4.elf
...
PRODUCT_NAME              = MinSegShield_Demo_M1V4
MAKEFILE                  = MinSegShield_Demo_M1V4.mk
COMPUTER                  = PCWIN64
...
MODELREF_LINK_RSPFILE_NAME = MinSegShield_Demo_M1V4_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/MinSegShield_Demo_M1V4.elf
...
DEFINES_STANDARD = -DMODEL=MinSegShield_Demo_M1V4 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/MinSegShield_Demo_M1V4_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/MinSegShield_Demo_M1V4_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/MinSegShield_Demo_M1V4_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
